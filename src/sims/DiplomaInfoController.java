...
public class DiplomaInfoController implements Initializable 
{
    @Override
    ...
    {           
        ...
        else
        {
            ...
            dataClass.setPassYearVal(0);
            passYear.setStyle(errorStyle);
            throw new NullPointerException("DPassYear2 null");
        }
    }
    ...
    {    
        ...
        { 
            ...
            throw new NullPointerException("DSchool null");        
        } 
        else 
        { 
            dataClass.setSchoolVal(tmp);
            school.setStyle(null);
        }
    }
    ...
    {   
        ...
        { 
            ...
            throw new NullPointerException("DCity null");           
        } 
        else 
        { 
    ...
    {           
        ...
        if (tmp != null && Float.parseFloat(tmp) <= 100.0) 
        {
            ...
            catch (NumberFormatException e) 
            {
                ...
                throw new NullPointerException("DPercentVal1 not a float");
            }
        }
        else
        {
            ...
            dataClass.setPercentVal(0.f);
            percent.setStyle(errorStyle);
            throw new NullPointerException("DPercentVal2 not a float");
        }
    ...
    private final DiplomaInfoData dataClass = DiplomaInfoData.getInstance();     
