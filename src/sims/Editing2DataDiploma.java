 ...
 * @author Vic's
 */
public class Editing2DataDiploma 
{
    ...
    private float percent1Val, percent2Val, percent3Val, percent4Val, percent5Val, percent6Val;   
                
    private static volatile Editing2DataDiploma instance = null;

    
    Editing2DataDiploma()
    {}
    
    public static Editing2DataDiploma getInstance() 
    {
        if(instance == null)
        {
            instance = new Editing2DataDiploma();
        }
        return instance;
    }
