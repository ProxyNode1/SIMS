...
public class Editing2DataSSC
{
    ...
    private static volatile Editing2DataSSC instance = null;
    
    
    private Editing2DataSSC()
    {}
    
        
    public static Editing2DataSSC getInstance()
    {
        if(instance == null)
        {
            instance = new Editing2DataSSC();
        }
