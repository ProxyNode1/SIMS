...
public class PGInfoController implements Initializable 
{
    @Override
    ...
    {           
        ...
        if (tmp != null && tmp.length() == 4) 
        {
            ...
            catch (NumberFormatException e) 
            {
                ...
                throw new NullPointerException("PPassYear1 null");
            }
        }
        else
        {
            ...
            dataClass.setPassYearVal(0);
            passYear.setStyle(errorStyle);
            throw new NullPointerException("PPassYear2 null");
        }
    }
    ...
    {    
        ...
        { 
            ...
            throw new NullPointerException("PSchool null");        
        } 
        else 
        { 
    ...
    {   
        ...
        { 
            ...
            throw new NullPointerException("PCity null");           
        } 
        else 
        { 
    ...
    {           
        ...
        if (tmp != null && Float.parseFloat(tmp) <= 100.0) 
        {
            ...
            catch (NumberFormatException e) 
            {
                ...
                throw new NullPointerException("PPercentVal1 not a float");
            }
        }
        else
        {
            ...
            dataClass.setPercentVal(0.f);
            percent.setStyle(errorStyle);
            throw new NullPointerException("PPercentVal2 not a float");
        }
    ...
    private final PGInfoData dataClass = PGInfoData.getInstance();
}
